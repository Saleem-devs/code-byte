      ...
      <section id="about" className="bg-bgColor text-center py-28">
        <div className="container md:w-2/3">
          ...
          <p className="text-lg text-primaryText mb-6">
            CodeByte is a powerful platform designed for front-end developers to
            bring their ideas to life. With its easy-to-use interface and
            editor, CodeByte empowers users to create and collaborate on web
            development projects from anywhere, on any device.
          </p>
          <p className="text-lg text-primaryText mb-6">
            Whether you're a seasoned developer or just getting started,
            CodeByte provides a streamlined and intuitive experience that makes
          ...
          <p className="text-lg text-primaryText mb-6">
            CodeByte provides a streamlined user interface that allows you to
